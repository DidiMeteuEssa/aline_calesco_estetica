                ...
                <table class="ficha-table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><textarea name="como_conheceu_trabalho_melasma" maxlength="500"><?= isset($linha_melasma['como_conheceu_trabalho']) ? $linha_melasma['como_conheceu_trabalho'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><textarea name="queixa_principal_melasma" maxlength="1000"><?= isset($linha_melasma['queixa_principal']) ? $linha_melasma['queixa_principal'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td><label for="tempo_percebeu_manchas_melasma">Há quanto tempo <br>você percebeu essa(s) <br> MANCHAS?</label></td>
                            <td><textarea name="tempo_percebeu_manchas_melasma" maxlength="500"><?= isset($linha_melasma['tempo_percebeu_manchas']) ? $linha_melasma['tempo_percebeu_manchas'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td><label for="tratou_melasma_melasma">Já tratou melasma antes?</label></td>
                            <td><textarea name="tratou_melasma_melasma" maxlength="1000"><?= isset($linha_melasma['tratou_melasma']) ? $linha_melasma['tratou_melasma'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td><label for="uso_acido_melasma">Já fez uso de ácido ou peeling?</label></td>
                            <td><textarea name="uso_acido_melasma" maxlength="500"><?= isset($linha_melasma['uso_acido']) ? $linha_melasma['uso_acido'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td><label for="problemas_saude_melasma">Possui algum problema de saúde?</label></td>
                            <td><textarea name="problemas_saude_melasma" maxlength="500"><?= isset($linha_melasma['problemas_saude']) ? $linha_melasma['problemas_saude'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td><label for="medicacao">Usa alguma medicação frequente? <br>Há quanto tempo?</label></td>
                            <td><textarea name="medicacao" maxlength="500"><?= isset($linha_melasma['medicacao']) ? $linha_melasma['medicacao'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align: center; padding-bottom: .5rem">
                        ...
                        <tr>
                            ...
                            <td><input type="text" maxlength="500" name="nivel_exposicao_radiacao" value="<?= isset($linha_melasma['nivel_exposicao_radiacao'])  ? $linha_melasma['nivel_exposicao_radiacao'] : '' ?>" style="width: 40rem;"></td>
                        </tr>
                        <tr>
                            <td><label for="temperatura_media_melasma">Temperatura media de <br> onde mora / trabalha:</label></td>
                            <td><input type="text" maxlength="500" name="temperatura_media_melasma" value="<?= isset($linha_melasma['temperatura_media'])  ? $linha_melasma['temperatura_media'] : '' ?>" style="width: 40rem;"></td>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align: center; padding-bottom: .5rem">
                        ...
                        <tr>
                            ...
                            <td><textarea name="tratamento_realizou" maxlength="1000"><?= isset($linha_melasma['tratamento_realizou']) ? $linha_melasma['tratamento_realizou'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><textarea name="rotina_dia_melasma" maxlength="1000"><?= isset($linha_melasma['rotina_dia']) ? $linha_melasma['rotina_dia'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td><label for="rotina_noite_melasma">Noite: </label></td>
                            <td><textarea name="rotina_noite_melasma" maxlength="1000"><?= isset($linha_melasma['rotina_noite']) ? $linha_melasma['rotina_noite'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="litros_agua" maxlength="500" value="<?= isset($linha_melasma['litros_agua']) ? $linha_melasma['litros_agua'] : '' ?>" style="width: 40rem;"></td>
                        </tr>
                        <tr>
                            <td><label for="diureticos">Ingere algum líquido diurético?</label></td>
                            <td><input type="text" name="diureticos" maxlength="500" placeholder="Bebida alcoólica, chás diuréticos, chimarrão..." value="<?= isset($linha_melasma['diureticos']) ? $linha_melasma['diureticos'] : '' ?>" style="width: 40rem;"></td>
                        </tr>
                        <tr>
                            <td><label for="qualidade_sono">Quantas horas de sono por dia?</label></td>
                            <td><input type="text" maxlength="500" name="qualidade_sono" value="<?= isset($linha_melasma['qualidade_sono']) ? $linha_melasma['qualidade_sono'] : '' ?>" style="width: 40rem;"></td>
                        </tr>
                        <tr>
                            <td><label for="exercicios_melasma">Você pratica alguma atividade física?</label></td>
                            <td><textarea name="exercicios_melasma" maxlength="500"><?= isset($linha_melasma['exercicios']) ? $linha_melasma['exercicios'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            ...
                            <td><textarea name="intestino" maxlength="500"><?= isset($linha_melasma['intestino']) ? $linha_melasma['intestino'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td colspan="2" style="text-align: center; padding-bottom: .5rem">
                        ...
                        <tr>
                            ...
                            <td><textarea name="concorda_troca_melasma" maxlength="500"><?= isset($linha_melasma['concorda_troca']) ? $linha_melasma['concorda_troca'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td><label for="indicacao_plano_tratamento_melasma">Indicação do plano de tratamento:</label></td>
                            <td><textarea name="indicacao_plano_tratamento_melasma" maxlength="1000"><?= isset($linha_melasma['indicacao_plano_tratamento']) ? $linha_melasma['indicacao_plano_tratamento'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td><label for="indicacao_skin_care_melasma">Indicação de skin care:</label></td>
                            <td><textarea name="indicacao_skin_care_melasma" maxlength="1000"><?= isset($linha_melasma['indicacao_skin_care']) ? $linha_melasma['indicacao_skin_care'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td><label for="indicacao_equipe_multidisciplinar_melasma">Indicação de equipe multidisciplinar:</label></td>
                            <td><textarea name="indicacao_equipe_multidisciplinar_melasma" maxlength="1000"><?= isset($linha_melasma['indicacao_equipe_multidisciplinar']) ? $linha_melasma['indicacao_equipe_multidisciplinar'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="indicacao_nutraceticos_orais_melasma" maxlength="1000"><?= isset($linha_melasma['indicacao_nutraceticos_orais']) ? $linha_melasma['indicacao_nutraceticos_orais'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td><label for="pontos_acordados_melasma">Pontos acordados:</label></td>
                            <td><textarea name="pontos_acordados_melasma" maxlength="1000"><?= isset($linha_melasma['pontos_acordados']) ? $linha_melasma['pontos_acordados'] : ''; ?></textarea></td>
                        </tr>
                        <tr>
                            <td><label for="constatacao_raiz_problema_melasma">Constatação da raiz do problema:</label></td>
                            <td><textarea name="constatacao_raiz_problema_melasma" maxlength="1000"><?= isset($linha_melasma['constatacao_raiz_problema']) ? $linha_melasma['constatacao_raiz_problema'] : ''; ?></textarea></td>
                        </tr>
                    </tbody>
                </table>
